...
export default function ItemDescription(){
    ...
    <div className='flex flex-col items-center justify-center mt-3' >
        ...
        <img src=""  className="w-60 h-60 rounded-lg sm:w-96 sm:h-96 "  alt="item" />
        ...
        <button  className=" mt-4 p-3 w-64 font-medium text-white text-lg bg-slate-600 rounded-full active:bg-black  hover:bg-slate-900">
               Reserve Now
        </button>
      </div>
      </>
